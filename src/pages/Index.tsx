...
const Index = () => {
  return (
    <div className="min-h-screen bg-background scroll-smooth">
      ...
      <SEO
        title="GameMedo | Athletic Website Design | Sports Videos & Graphics | GameMedo"
        description="GameMedo provides sports highlight videos, athletic website design, social media management, and virtual assistant services for school athletic departments."
