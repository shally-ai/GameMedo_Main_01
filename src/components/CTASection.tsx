...
import { Sparkles, Users, Zap, Clock, ShieldCheck, Calendar as CalendarIcon } from "lucide-react";
      ...
      <div className="container mx-auto max-w-6xl relative z-10 px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary mb-4">
            ...
            <span className="text-xs font-heading tracking-[0.3em] uppercase">Limited Slots Available</span>
          </div>
          <h2 className="font-heading text-4xl md:text-6xl font-bold uppercase leading-tight pb-2">
            Ready to <span className="text-gradient">Level Up</span> <br />
            Your Team's Brand?
          </h2>
          <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto font-medium mt-4">
            Join 50+ elite programs who trust GameMedo for their game-day graphics and video highlights. Book your free strategy call below — no commitment required.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          >
              ...
              {[
                {
                  ...
                  desc: "Direct access to our elite design lead — zero gatekeeping."
                },
                {
                  icon: <Zap className="w-5 h-5" />,
                  title: "Brand Audit & Growth Plan",
                  desc: "We analyze your current brand and identify quick wins for next season."
                },
                {
                  icon: <Clock className="w-5 h-5" />,
                  title: "Fast-Track Results",
                  desc: "Get a clear roadmap for your program before the next game day."
                }
              ].map((item, i) => (
                <motion.div
                  key={i}
            ...
            <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.2em] font-heading text-muted-foreground/60 pt-2">
              <span className="flex items-center gap-2"><ShieldCheck className="w-4 h-4 text-green-500/50" /> Secure Booking</span>
              <span className="w-1 h-1 rounded-full bg-border" />
              <span className="flex items-center gap-2"><CalendarIcon className="w-4 h-4 text-primary/50" /> Instant Calendar Sync</span>
              <span className="w-1 h-1 rounded-full bg-border" />
              <span>Free — No Credit Card</span>
            </div>
          </motion.div>

          {/* Right Side: Embedded Calendar */}
          <motion.div
          ...
          >
            <div className="relative">
              <div className="relative bg-[#0a0a0a] rounded-2xl overflow-hidden border border-white/10 shadow-[0_30px_100px_-20px_rgba(0,0,0,0.8)]">
                ...
                <div className="relative w-full bg-white h-[600px] md:h-[700px] overflow-hidden">
                  {!isLoaded && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[8px] uppercase tracking-widest text-muted-foreground mt-1">Valued at $150.00 — on us</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
